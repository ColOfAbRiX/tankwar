...
It's nice to have people that helps you, it enriches the project with new ideas and speed up the development.

Please, follow this guidelines to make sure a certain quality of the code is met and to allow people to work smoothly
togeter.
...
A private installation of Atlassian JIRA is used to organise the workload and the tasks are not visible to the public.
...
For these reasons, an more, the code style settings of Intellij IDEA are provided and can be imported when insite the IDE
itself with:
