package com.colofabrix.scala.neuralnetworkOld.tests

import java.io.{File, PrintWriter}

import com.colofabrix.scala.neuralnetworkOld.abstracts.{ActivationFunction, NeuronLayer}
import com.colofabrix.scala.neuralnetworkOld.activationfunctions.{Linear, Sigmoid}
