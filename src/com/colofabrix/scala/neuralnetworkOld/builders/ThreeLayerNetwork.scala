...
import com.colofabrix.scala.neuralnetworkOld.builders.abstracts.{BehaviourBuilder, DataReader, StructureBuilder}
import com.colofabrix.scala.neuralnetworkOld.layers.InputLayer
