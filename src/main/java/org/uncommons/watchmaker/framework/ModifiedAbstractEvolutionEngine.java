...
public abstract class ModifiedAbstractEvolutionEngine<T> implements EvolutionEngine<T> {
     ...
     */
    protected ModifiedAbstractEvolutionEngine(CandidateFactory<T> candidateFactory,
