 ...
 */
public abstract class OpenAbstractEvolutionEngine<T> implements EvolutionEngine<T>
{
     ...
     */
    protected OpenAbstractEvolutionEngine(CandidateFactory<T> candidateFactory,
